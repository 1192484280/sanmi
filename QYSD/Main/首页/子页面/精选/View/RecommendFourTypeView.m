...
@interface RecommendFourTypeView ()<UICollectionViewDelegate,UICollectionViewDataSource>
...
@implementation RecommendFourTypeView

//- (NSArray *)listArr{
//
//    if (!_listArr) {
//
//        RecommendFourTypeModel *model1 = [[RecommendFourTypeModel alloc] init];
//        model1.name = @"母婴专区";
//        model1.des = @"妈妈必备 宝宝开心";
//        model1.color = @"CDC3FF";
//        model1.img = @"母婴专区";
//
//        RecommendFourTypeModel *model2 = [[RecommendFourTypeModel alloc] init];
//        model2.name = @"品牌券";
//        model2.des = @"大牌抢购 品质好货";
//        model2.color = @"F7CF89";
//        model2.img = @"品牌券";
//
//        RecommendFourTypeModel *model3 = [[RecommendFourTypeModel alloc] init];
//        model3.name = @"大额券";
//        model3.des = @"折扣必抢 超级优惠";
//        model3.color = @"F7C2BD";
//        model3.img = @"大额券";
//
//        RecommendFourTypeModel *model4 = [[RecommendFourTypeModel alloc] init];
//        model4.name = @"高拥榜";
//        model4.des = @"超高奖励 热门疯抢";
//        model4.color = @"BCE6FC";
//        model4.img = @"高拥榜";
//
//        _listArr = @[model1, model2, model3, model4];
//    }
//    return _listArr;
//}
...
- (UICollectionView *)collectionView{
    ...
    if (!_collectionView) {
        ...
        if (!_collectionView) {
            ...
            CGFloat itemH = (fourType_h - 0.5) / 2;
